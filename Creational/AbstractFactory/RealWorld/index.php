...
class Page 
{
    ...
    // Here's how you would use the template further in real life. Note that the
    // page class does not depend on any contrete template classes.
...
/**
 * Home-made Twig renderer class.
 */
class Twig
{
    public static function render(string $string, array $arguments = [])
    {
        return 'This is a Twig template: ' . PHP_EOL . $string . PHP_EOL;
    }
}
