...
namespace RefactoringGuru\Creational\AbstractFactory\Conceptual;

/**
 * The Abstract Factory interface decleares a set of methods that return
...
class ConcreteProductA1 implements AbstractProductA
{
    public function usefulFunctionA(): string
    {
        return 'The result of the product A1.' . PHP_EOL;
    }
}
...
class ConcreteProductB1 implements AbstractProductB 
{
    ...
    public function anotherUsefulFunctionB(AbstractProductA $collaborator): string 
    {
        ...
        return "The result of the B1 collaborating with the ({$result})" . PHP_EOL;
    }
}
...
class ConcreteProductB2 implements AbstractProductB
{
    ...
    public function anotherUsefulFunctionB(AbstractProductA $collaborator): string 
    {
        ...
        return "The result of the B2 collaborating with the ({$result})" . PHP_EOL;
    }
}
 ...
 * product subclas to the client code without breaking it.
 */
