...
namespace RefactoringGuru\Structural\Composite\RealWorld;

/**
 * The base Component class declares an interface for all concrete components,
 * both siple and complex.
 * 
...
abstract class FieldComposite extends FormElement
{
    ...
    /**
     * The base implentation of the Composite's rendering simply combines
...
/**
 * The client code can work form elements using the abstract interface.
 * This way, it doesn't matter whether the client works with a simple component
 * or a complex composite one.
 */
